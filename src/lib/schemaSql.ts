...
CREATE POLICY "Public can submit pioneer application" ON public.pioneer_applications FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Public can query pioneer applications" ON public.pioneer_applications;
CREATE POLICY "Public can query pioneer applications" ON public.pioneer_applications FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow updates on pioneer applications" ON public.pioneer_applications;
CREATE POLICY "Allow updates on pioneer applications" ON public.pioneer_applications FOR UPDATE USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow read contributor profiles" ON public.contributor_profiles;
CREATE POLICY "Allow read contributor profiles" ON public.contributor_profiles FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow insert contributor profiles" ON public.contributor_profiles;
CREATE POLICY "Allow insert contributor profiles" ON public.contributor_profiles FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow update contributor profiles" ON public.contributor_profiles;
CREATE POLICY "Allow update contributor profiles" ON public.contributor_profiles FOR UPDATE USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow read squad tasks" ON public.squad_tasks;
CREATE POLICY "Allow read squad tasks" ON public.squad_tasks FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow modify squad tasks" ON public.squad_tasks;
CREATE POLICY "Allow modify squad tasks" ON public.squad_tasks FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow insert proof of work" ON public.pioneer_proof_of_work;
CREATE POLICY "Allow insert proof of work" ON public.pioneer_proof_of_work FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Allow read proof of work" ON public.pioneer_proof_of_work;
CREATE POLICY "Allow read proof of work" ON public.pioneer_proof_of_work FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow update proof of work" ON public.pioneer_proof_of_work;
CREATE POLICY "Allow update proof of work" ON public.pioneer_proof_of_work FOR UPDATE USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow read certificates" ON public.pioneer_certificates;
CREATE POLICY "Allow read certificates" ON public.pioneer_certificates FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow manage certificates" ON public.pioneer_certificates;
CREATE POLICY "Allow manage certificates" ON public.pioneer_certificates FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "Allow read staff" ON public.staff_members;
CREATE POLICY "Allow read staff" ON public.staff_members FOR SELECT USING (true);

DROP POLICY IF EXISTS "Allow manage staff" ON public.staff_members;
CREATE POLICY "Allow manage staff" ON public.staff_members FOR ALL USING (true) WITH CHECK (true);
`;
